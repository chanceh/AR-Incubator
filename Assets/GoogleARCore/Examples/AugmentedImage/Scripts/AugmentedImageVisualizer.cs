...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    public class AugmentedImageVisualizer : MonoBehaviour
    {
        ...
        public float publicXOffset = 0f;
        public float publicYOffset = 0f;
        /// <summary>
        ...
        public void Update()
        {
            ...
            float xOffset = publicXOffset;
            float yOffset = publicYOffset;
            ...
            buildingMesh.transform.localPosition = (xOffset * Vector3.right) + (yOffset * Vector3.forward);
            //Debug.Log(xOffset);
            //Debug.Log(yOffset);
